...
<title>Admin Registration Data - RSCM</title>
...
<body id="refresh" name="refresh" value="refresh"
	...
	<div class="wrapper">
		...
		<center>
			<br> <br>
			<div class="title">Admin Registration Data</div>
		</center>
		<div
			style="text-align: right; padding-right: 20px; padding-bottom: 10px;">
			<a href="deleteAllAdminRegistrationData" style="color: white;">Delete
				All</a>
		</div>
		<table>
			<thead>
			...
			<c:forEach var="item" items="${AdminRegistrationData}">
				<tr>
					...
					<td><a href="removeAdmin/${item.adminLoginId}">remove</a></td>
				</tr>
			</c:forEach>
		</table>
	</div>
