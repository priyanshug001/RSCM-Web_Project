...
if (Username != null) {
%>
<body id="refresh" name="refresh" value="refresh" onload="autoRefresh()">
	<div class="wrapper">
		<br>
		<center>
			<br> <br>
			<div class="title">Contact Data</div>
		</center>
		<div
			style="text-align: right; padding-right: 20px; padding-bottom: 10px;">
			<a href="deleteAllContactData" style="color: white;">Delete All</a>
		</div>
		<table>
			<thead>
				<tr>
